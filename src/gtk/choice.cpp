...
GtkListItemFactory* wxGTKCreateEllipsizingLabelFactory()
{
...
bool wxChoice::GTKMoveSelection(unsigned int keyval)
{
    ...
    SetSelection(wanted);
    SendSelectionChangedEvent(GTKGetSelectionEventType());
...
wxEventType wxChoice::GTKGetSelectionEventType() const
{
    return wxEVT_CHOICE;
}
